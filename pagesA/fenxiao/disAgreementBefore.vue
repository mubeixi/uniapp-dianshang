<template>
	<view @click="commonClick">
		<div class="pro_detail">
			...
			<!-- #endif -->
			<view class="btn" v-if="pro.dis_config.Dis_Agreement_btn.btn_name" @click="goDis" :style="{'color':'#'+pro.dis_config.Dis_Agreement_btn.btn_text_color,'backgroundColor':'#'+pro.dis_config.Dis_Agreement_btn.btn_color}">
