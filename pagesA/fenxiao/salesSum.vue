<template>
    <view class="profitSum">
        ...
        <view class="order" v-for="(item,i) of resData " :key="i">
            ...
            <view class="view">
                订单价格：<text style="color: #F43131">{{item.Order_TotalPrice}}元</text>
            </view >
            <view class="view">
                订单业绩：<text style="color: #F43131">{{item.sales}}元</text>
            </view>
            <view class="view">
                描述信息：<text >{{item.descr}}</text>
            </view>
            <view class="view">
                创建时间：<text >{{item.create_time}}</text>
            </view>
        </view>
