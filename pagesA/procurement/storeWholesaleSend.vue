  ...
  <div @click="commonClick" class="wrap">
              ...
              <div class="goods" v-for="(item,idx2) in apply.prod_list">
                ...
                <div class="c">
                  ...
                  <div class="flex flex-between">
                    ...
                    <div @click="setCurrentGoods(item)" class="inputNumber">
                      <div @click="minusFn(item)" class="clicks">-</div>
                      <input :value="item.prod_count" @blur="setValFn" class="inputq" type="number">
    ...
    <div class="sendbox">
      ...
      <div class="row" v-if="is_need_shipping">
        ...
        <input class="form-item" placeholder="请输入快递单号" v-model="ShippingID" />
      </div>
      <!-- <div class="row" v-if="is_need_shipping">
...
export default {
  ...
  methods: {
    ...
    minusFn (goods) {
      ...
      // goods.prod_count--
      this.updateGoodsStock(this.apply.Order_ID, goods.prod_id, Attr_ID, goods.prod_count - 1, function () {
        goods.prod_count--
      })
    },
