<template>
	<view @click="commonClick" class="wrap">
		...
		<view class="item">
			...
			<view class="item-input">
				<input :disabled="is_submitted" maxlength="11" placeholder="请输入联系电话" placeholder-style="color:#CAC8C8" type="text"
				       v-model="store_mobile" />
			</view>
		</view>
		<view class="item">
			<view class="item-left">门店地址</view>
			<picker :disabled="is_submitted" :range="change_objectMultiArray" :value="change_multiIndex" @change="bindMultiPickerChange"
