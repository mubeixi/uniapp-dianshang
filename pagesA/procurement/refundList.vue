<template>
    <div class="wrap" @click="commonClick">
        <div class="navs">
            <div class="nav-item" :class="tabidx===5?'active':''" @click="changIndex(5)">全部</div>
            <div class="nav-item" :class="tabidx===0?'active':''" @click="changIndex(0)">待确认</div>

            <div class="nav-item" :class="tabidx===1?'active':''" @click="changIndex(1)">待发货</div>
            <div class="nav-item" :class="tabidx===2?'active':''" @click="changIndex(2)">待收货</div>
            <div class="nav-item" :class="tabidx===3?'active':''" @click="changIndex(3)">待退款</div>
            <div class="nav-item" :class="tabidx===4?'active':''" @click="changIndex(4)">已完成</div>
        </div>
        <view class="space-box">
        </view>
        <div class="container">
            <div class="order" v-for="(item,index) of applys" :key="index" >
    ...
    export default {
        ...
        methods:{
            ...
            refuseApply(){
                ...
                systemRefuseApply({Back_ID:this.activeApply,reason:this.reason, store_id: this.Stores_ID},{tip:'处理中'}).then(res=>{
                    this.$refs.refuseApply.close()
                    this.reason = ''
                    uni.showToast({
                        title: res.msg
