<template>
	<view v-if="pro.img_url">
		...
		<!-- #endif -->
		<view class="top">
			<image class="widthTen" src="https://new401.bafangka.com/static/client/task/top.png" ></image>
			...
			<view class="center">
				<!-- <image class="widthTen" src="https://new401.bafangka.com/static/client/task/center.png" ></image> -->
