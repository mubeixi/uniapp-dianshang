<template>
	<div @click="commonClick" class="wrap" style="position:relative;">
		...
		<!-- #ifndef APP-PLUS -->
		<bottom :canSubmit="canSubmit" :collected="isCollected" :isGiftPackage="is_gift_package_pro" :isVirtual="isVirtual" :recieve="recieve"
		...
		<popupLayer :direction="'top'" @maskClicked="handClicked" ref="cartPopu">
			<div class="cartSku">
				<div class="cartTop">
					<image :src="skuImg?skuImg+'-r200':(product.Products_JSON.ImgPath[0]?product.Products_JSON.ImgPath[0]+'-r200':'')" @click="yulanDetail"
					       class="image"></image>
					<div class="cartTitle">
...
import {getProductThumb, numberSort} from '../../common/tool.js'
