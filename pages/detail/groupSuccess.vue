    ...
    <div class="first">
      ...
      <div class="right">
        ...
        <div class="bottom">
          <div class="price">
            ¥<span
          class="prices">{{product.pintuan_pricex}}</span><span>拼团省{{product.Products_PriceX.pintuan_pricex}}</span>
          </div>
          <div class="tuan">
...
import { getOrderDetail, getPintuanTeam, getProd, getProductDetail, getProductSharePic } from '../../common/fetch'
import { buildSharePath, getGroupCountdown, getProductThumb, ls } from '../../common/tool'
