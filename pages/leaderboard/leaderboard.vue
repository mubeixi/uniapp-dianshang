		...
		<view class="mains">
			...
			<view class="content" v-for="(item,index) of pro " :key="index" v-if="index==0">
				<view class="contentLeft" >
					<view class="ming">
						<image src="https://new401.bafangka.com/static/client/fenxiao/first.png" ></image>
					</view>
					<view class="info">
			...
			<view class="content" v-else-if="index==1">
				<view class="contentLeft">
					<view class="ming">
						<image src="https://new401.bafangka.com/static/client/fenxiao/second.png" ></image>
					</view>
					<view class="info">
							<image :src="item.Shop_Logo" ></image>
						</view>
			...
			<view class="content" v-else-if="index==2">
				<view class="contentLeft">
					<view class="ming">
						<image src="https://new401.bafangka.com/static/client/fenxiao/three.png" ></image>
					</view>
					<view class="info">
							<image :src="item.Shop_Logo" ></image>
					</view>
