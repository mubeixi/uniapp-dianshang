<template>
    <view class="wrap">
        ...
        <div class="rotate-box">
            ...
            <div class="item"  :style="getStyle(2)" style="margin-right: 0">
                <div class="goods">
            ...
            <div class="item"  :style="getStyle(3)" style="margin-right: 0">
                <div class="goods">
            ...
            <div class="item"  :style="getStyle(4)" style="margin-right: 0">
                <div class="goods">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            getStyle(idx){
                if(idx!=this.activeIdx || !rotateInstance.isStart())return {}
                return {backgroundColor:rotateInstance.getBgColor(idx)}
            }
        },
        created(){
